...
CONFIG.NUM_MI {6} \
  ...
  connect_bd_intf_net -intf_net PmodOLED_0_Pmod_out [get_bd_intf_ports jb] [get_bd_intf_pins PmodOLED_0/Pmod_out]
  connect_bd_intf_net -intf_net PmodRTCC_0_Pmod_out [get_bd_intf_ports ja] [get_bd_intf_pins PmodRTCC_0/Pmod_out]
  connect_bd_intf_net -intf_net PmodTMP3_0_Pmod_out [get_bd_intf_ports jc] [get_bd_intf_pins PmodTMP3_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PmodOLED_0/AXI_LITE_SPI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins PmodOLED_0/AXI_LITE_GPIO] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins PmodTMP3_0/AXI_LITE_IIC] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodOLED_0/s_axi_aclk] [get_bd_pins PmodRTCC_0/s_axi_aclk] [get_bd_pins PmodTMP3_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PmodOLED_0/s_axi_aresetn] [get_bd_pins PmodRTCC_0/s_axi_aresetn] [get_bd_pins PmodTMP3_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodOLED_0/AXI_LITE_SPI/Reg0] SEG_PmodOLED_0_Reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodOLED_0/AXI_LITE_GPIO/Reg0] SEG_PmodOLED_0_Reg01
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodRTCC_0/AXI_LITE_IIC/Reg0] SEG_PmodRTCC_0_Reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x40002000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodTMP3_0/AXI_LITE_IIC/Reg0] SEG_PmodTMP3_0_Reg0
...
#  -string -flagsOSRD
preplace port btns_4bits -pg 1 -y 620 -defaultsOSRD
preplace port DDR -pg 1 -y 40 -defaultsOSRD
preplace port ja -pg 1 -y 120 -defaultsOSRD
preplace port jb -pg 1 -y 260 -defaultsOSRD
preplace port jc -pg 1 -y 380 -defaultsOSRD
preplace port sws_4bits -pg 1 -y 640 -defaultsOSRD
preplace port leds_4bits -pg 1 -y 510 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace inst PmodTMP3_0 -pg 1 -lvl 3 -y 390 -defaultsOSRD
preplace inst PmodOLED_0 -pg 1 -lvl 3 -y 260 -defaultsOSRD
preplace inst PmodRTCC_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 630 -defaultsOSRD
...
preplace netloc PmodOLED_0_Pmod_out 1 3 1 NJ
preplace netloc processing_system7_0_DDR 1 1 3 NJ 40 NJ 40 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 N
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 650 750
preplace netloc PmodTMP3_0_Pmod_out 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 440 410
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 740
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 710
preplace netloc PmodRTCC_0_Pmod_out 1 3 1 NJ
...
preplace netloc ps7_0_axi_periph_M04_AXI 1 2 1 760
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 630 420 630 730
...
levelinfo -pg 1 0 220 570 880 1020 -top 0 -bot 700
",
}
